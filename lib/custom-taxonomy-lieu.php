...
function _themename_create_modalite_lieu() {
	...
	$labels = array(
		...
		'edit_item'         => __( 'Lieu', '_themename' ),
		'update_item'       => __( 'Lieu', '_themename' ),
		'add_new_item'      => __( 'Ajouté une modalité du Lieu', '_themename' ),
		'new_item_name'     => __( 'Lieu', '_themename' ),
		'menu_name'         => __( 'Lieu', '_themename' ),
	);
	$args = array(
		'labels' => $labels,
		'description' => __( 'Lieu', '_themename' ),
		'hierarchical' => false,
		'public' => true,
