...
function _themename_create_modalite_sens() {
	...
	$labels = array(
		...
		'edit_item'         => __( 'Sens', '_themename' ),
		'update_item'       => __( 'Sens', '_themename' ),
		'add_new_item'      => __( 'Ajouté une modalité du Sens', '_themename' ),
		'new_item_name'     => __( 'Sens', '_themename' ),
		'menu_name'         => __( 'Sens', '_themename' ),
	);
	$args = array(
		'labels' => $labels,
		'description' => __( 'Sens', '_themename' ),
		'hierarchical' => false,
		'public' => true,
