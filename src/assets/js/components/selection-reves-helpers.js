const sd = {
    buttonsSelectionRevePastille: document.querySelectorAll(".button--select-to-download"),
    buttonsSelectionReve: document.querySelectorAll(".article-reve--download"),
    pastille: document.querySelector(".button--selected-number"),
    pastilleText: document.querySelector(".button--selected-number p"),
    popup: document.querySelector(".popup--download"),
    closeB: document.querySelector(".popup--download-close-button"),
    downloadTable: document.querySelector(".container--reve-to-download"),
    tables: document.querySelectorAll(".reve--to-print"),
    buttonAllSelected: document.querySelector(".button--select"),
    downloadButton: document.querySelector(".button--download"),
    previewButton: document.querySelector(".button--preview"),
