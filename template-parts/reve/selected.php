...
?>
    ...
    <!-- data-taxonomy="<?php echo esc_html( $term_typologie->slug ); ?> <?php echo esc_html( $term_lucidite->slug ); ?> <?php echo esc_attr( get_the_date( 'mY' ) ); ?>" -->

        <?php

        echo '<p>the year(s) of the post are ' . get_the_date( 'Y' ) . '</p>';
